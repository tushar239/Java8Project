...
public class Java8CompletableFutureExample {
    ...
    private static void completableFutureExamples() throws InterruptedException, ExecutionException {
        // Example of supplyAsync, complete, whenComplete, thenApply, thenAccept, get methods.
        {
            ...
            // See the beauty of CompletableFuture - if thread that was run by it gives the result can either result or exception. It doesn't throw that exception, if raised. It sets it in future object and gives it handle back to caller. Let caller decide what does it want to do with that exception. This is functional programming.
