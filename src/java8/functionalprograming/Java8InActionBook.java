...
Chapter 6   (Collecting data with streams)
    ...
    Other Syntaxes:
        ...
        https://www.javacodegeeks.com/2016/03/multi-level-grouping-streams.html
...
Chapter 7 (Parallel data processing and performance)
    ...
    7.1.2. Measuring stream performance
        ...
        // and
        Stream.iterate(1, i -> i+1).limit(10) ---- int to Integer has to be done in iterate method
                .parallel()
                .reduce(0, (i1, i2) -> i1 + i2);
        // and
        IntStream.range(0, 10).parallel() --- range method accepts int, so no boxing required
                .reduce(0, (i1, i2) -> i1+i2);
    ...
    7.1.3. Using parallel streams correctly
            ...
            (IMP) When parallel processing gives worse performance compare to sequential processing?
                ...
                - For better parallelization, use ArrayList instead of LinkedList.
                  ArrayList can be splitted in between threads faster than LinkedList. (IMP)
            ...
            In particular, operations such as sorted/distinct/skip/limit(all stateful operations) and findFirst that
            rely on the order of the elements are expensive in a parallel stream.
            ...
            - (IMP) For a SMALL amount of data, choosing a parallel stream is almost never a winning decision.
            ...
            - (IMP) Take into account how well the data structure underlying the stream decomposes.
            For instance, an ArrayList can be split much more efficiently than a LinkedList,
            because the first can be evenly divided without traversing it, as it’s necessary to do with the second.
            ...
            - (IMP) Consider whether a terminal operation has a cheap or expensive deleteRootAndMergeItsLeftAndRight step (for example, the combiner method in a Collector).
        ...
        Method that you can create is:
            ...
            Approach 2 (Currying):
                ...
                From Chapter 14:
                            ...
                            Function<Double, Double> reusable = converter(5, 6);
                            result = reusable.apply(10);
                            result = reusable.apply(20);
                            result = reusable.apply(30);

                            Function<Double> anotherReusable = converter(6, 7);
                            result = anotherReusable.apply(10);
                            result = anotherReusable.apply(20);
                            result = anotherReusable.apply(30);
