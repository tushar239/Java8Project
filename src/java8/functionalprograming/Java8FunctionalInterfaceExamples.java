...
/*
    ...
    Interface Default Methods:-
        ...
        - Default methods will help us in removing base implementation classes, we can provide default implementation and the implementation classes can chose which one to override.
          Well, but it can't replace abstract class. Implementation method in abstract class can access instance variables of abstract class. Interface can't have instance variables, so basically default method cannot replace implementation method in abstract class and so interface cannot replace abstract class.
        ...
        - Default method can be overridden by child class. Static method can't be.
    ...
    Identity Function:-
        ...
        What is the usage of Identity Function?
        e.g. collect method has Collector that has supplier
                                                    augmenter
                                                    combiner
                                                    finalizer
             as arguments.
             finalizer is a function that is invoked after result from all parallel threads are combined using combiner. If don't want to change combined result, then u can just return Function.identity() from finalizer.
